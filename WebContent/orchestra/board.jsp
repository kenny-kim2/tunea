...
<%@page import="com.tunea.model.OrchBoard" %>
<%@page import="com.tunea.dao.OrchBoardDao" %>
...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%
	OrchBoardDao BoardDao = new JdbcOrchBoardDao();
	int p = 1;
	String field = "TITLE";
	String query = "";
	...
	if(_query != null && !_query.equals(""))
		query = _query;
	List<OrchBoard> list = OrchBoardDao.getOrchb(p, query, field);
	pageContext.setAttribute("list", list);
	pageContext.setAttribute("total", OrchBoardDao.getSize(""));
%>
<!DOCTYPE html>
...
<head>
    ...
    <link href="css/board-layout.css" rel="stylesheet" type="text/css" />
    <link href="css/board-style.css" rel="stylesheet" type="text/css" />
    <link href="css/board-deploy.css" rel="stylesheet" type="text/css" />
        ...
        <div class="content-wrapper clearfix">
                ...
                <div id="sub-menu-box">
                    <nav id="sub-menu-list">
                        ...
                        <ul>
                            ...
                            <li class="sub-menu-item"><a class="sub-menu-item-text" href="../orchestra/notice.html">공지사항</a></li>
            ...
            <main id="main">
                ...
                <div id="orch-search-container">
                    <div id="search-form">
                        <h3 class="hidden">오케스트라 게시판 검색 폼</h3>
                        <form>
                            <fieldset>
                                <legend class="hidden">오케스트라 게시판 검색 필드</legend>
                ...
                <div id="orch-board-list">
                    <h3 class="hidden">오케스트라 게시판 목록</h3>
                            ...
                            <tr class="orch-board-row">
                                <td class="orch-board-cell">
                                    <table class="orch-board-cell-table">
                                        <tbody>
                                            <tr>
                                                <td colspan="2" class="orch-board-cell-row title"><a href="../orchestra/board_view.html">${n.title}</a></td>
                                            </tr>
                                            <tr>
                                                <td class="orch-board-cell-row writer">임종진 임종진 임종진 임종진 임종진</td>
                                                <td class="orch-board-cell-row date">${n.regdate}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="2" class="orch-board-cell-row content">
                                                    <a href="../orchestra/board_view.html">
                                                        <p>
                                ...
                                <td class="orch-board-cell">
                                    <table class="orch-board-cell-table">
                                        <tbody>
                                            <tr>
                                                <td colspan="2" class="orch-board-cell-row title"><a href="../orchestra/board_view.html">건의합니다 동해물과 백두산이 마르고 닳도록</a></td>
                                            </tr>
                                            <tr>
                                                <td class="orch-board-cell-row writer">임종진 임종진 임종진 임종진 임종진</td>
                ...
                <div class="write-menu">
                    ...
                    <p class="write-item"><a href="../orchestra/board_write.html">글쓰기</a></p>
                </div>
            </main>
        </div>
    </div>
